 ...
 * Original file: /home/alan/android/workspace/BlackList/src/com/android/internal/telephony/ITelephony.aidl
 */
...
case TRANSACTION_transmitIccLogicalChannel:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
java.lang.String _result = this.transmitIccLogicalChannel(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6);
reply.writeNoException();
reply.writeString(_result);
return true;
}
case TRANSACTION_transmitIccAPDU:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
java.lang.String _result = this.transmitIccAPDU(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
reply.writeNoException();
reply.writeString(_result);
return true;
}
case TRANSACTION_openIccLogicalChannel:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
int _result = this.openIccLogicalChannel(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_closeIccLogicalChannel:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.closeIccLogicalChannel(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public java.lang.String transmitIccLogicalChannel(int cla, int command, int channel, int p1, int p2, int p3, java.lang.String data) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
mRemote.transact(Stub.TRANSACTION_transmitIccLogicalChannel, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
@Override public java.lang.String transmitIccAPDU(int cla, int command, int p1, int p2, int p3, java.lang.String data) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
_data.writeInt(p3);
_data.writeString(data);
mRemote.transact(Stub.TRANSACTION_transmitIccAPDU, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
@Override public int openIccLogicalChannel(java.lang.String AID) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
mRemote.transact(Stub.TRANSACTION_openIccLogicalChannel, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
@Override public void closeIccLogicalChannel(int channel) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(channel);
mRemote.transact(Stub.TRANSACTION_closeIccLogicalChannel, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_transmitIccLogicalChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_transmitIccAPDU = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_openIccLogicalChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_closeIccLogicalChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
}
/**
     * Dial a number. This doesn't place the call. It displays
     * the Dialer screen.
...
public java.lang.String transmitIccLogicalChannel(int cla, int command, int channel, int p1, int p2, int p3, java.lang.String data) throws android.os.RemoteException;
public java.lang.String transmitIccAPDU(int cla, int command, int p1, int p2, int p3, java.lang.String data) throws android.os.RemoteException;
public int openIccLogicalChannel(java.lang.String AID) throws android.os.RemoteException;
public void closeIccLogicalChannel(int channel) throws android.os.RemoteException;
}
